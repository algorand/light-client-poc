...
require (
	...
	github.com/algorand/go-stateproof-verification v0.1.0 // indirect
	github.com/algorand/go-sumhash v1.0.0 // indirect
	golang.org/x/crypto v0.0.0-20220321153916-2c7772ba3064 // indirect
	golang.org/x/sys v0.0.0-20220319134239-a9b59b0215f8 // indirect
)

replace github.com/algorand/go-algorand-sdk v1.17.0 => github.com/almog-t/go-algorand-sdk v1.14.1-0.20220831113422-8711424197c8
